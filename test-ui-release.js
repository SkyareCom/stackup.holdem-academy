...
assert('service worker cache was bumped for audited visual assets',serviceWorker.includes("CACHE='stackup-academy-v114'")&&serviceWorker.includes('SW_VERSION=114')&&serviceWorker.includes("['i18n-en-us-words-extra-4.js',3]")&&serviceWorker.includes("['fundamentals-interactive-bank.js',2]")&&serviceWorker.includes("['fundamentals-visual-layer.js',4]")&&serviceWorker.includes("['academy-visual-system.js',5]")&&serviceWorker.includes("['academy-loader.js',15]"));
