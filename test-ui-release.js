...
assert('service worker cache was bumped for audited visual assets',serviceWorker.includes("CACHE='stackup-academy-v118'")&&serviceWorker.includes('SW_VERSION=118')&&serviceWorker.includes("['release-compliance.js',2]")&&serviceWorker.includes("'./ph4-footer-logo.webp'")&&serviceWorker.includes("['fundamentals-visual-layer.js',5]")&&serviceWorker.includes("['fundamentals-interactive.js',7]")&&serviceWorker.includes("['modalities-module.js',4]")&&serviceWorker.includes("['mixed-games-module.js',5]")&&serviceWorker.includes("['academy-visual-system.js',5]")&&serviceWorker.includes("['academy-loader.js',16]"));
