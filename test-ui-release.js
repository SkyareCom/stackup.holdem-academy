...
assert('service worker cache was bumped for audited visual assets',serviceWorker.includes("CACHE='stackup-academy-v111'")&&serviceWorker.includes('SW_VERSION=111')&&serviceWorker.includes("['fundamentals-visual-layer.js',3]")&&serviceWorker.includes("['academy-visual-system.js',4]")&&serviceWorker.includes("['academy-loader.js',15]"));
