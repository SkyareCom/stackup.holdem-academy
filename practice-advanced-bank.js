(() => {
  ...
  [[4,'FLOP'],[8,'FLOP'],[9,'FLOP'],[12,'TURN'],[6,'TURN']].forEach(([o,st])=>{const mult=st==='FLOP'?4:2, v=o*mult;madd('REGRA 2/4',`${o} outs limpos no ${st}. Pela regra rápida, qual chance aproximada ${st==='FLOP'?'até o river':'na próxima carta'}?`,[`${v}%`,`${o*2}%`,`${o*3}%`],`${v}%`,`A regra prática usa outs × ${mult} neste contexto.`)} );
