(() => {
  ...
  const summaries={
    ...
    'ALPHA DO BLUFF':'Mostra quantos folds um bluff sem equity precisa gerar para empatar. Compare esse ponto necessário com a frequência de folds que você espera do adversário.',
