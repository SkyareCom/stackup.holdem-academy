const CACHE="stackup-academy-v28";
...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=28");
      ...
      if(!html.includes("fundamentals-interactive.js"))html=html.replace("</body>",'<script src="./fundamentals-interactive.js?v=1"></script></body>');
