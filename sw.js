...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=51");
      ...
      html=html.replace(/highlight-card-style\.js\?v=\d+/g,"highlight-card-style.js?v=22");
      ...
      html=html.replace(/practice-advanced\.js\?v=\d+/g,"practice-advanced.js?v=1");
      ...
      if(!html.includes("highlight-card-style.js"))html=html.replace("</body>",'<script src="./highlight-card-style.js?v=22"></script></body>');
      ...
      if(!html.includes("practice-advanced.js"))html=html.replace("</body>",'<script src="./practice-advanced.js?v=1"></script></body>');
