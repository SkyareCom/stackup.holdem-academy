const CACHE="stackup-academy-v9";
const ASSETS=["./","./index.html","./manifest.webmanifest","./engine.js","./ranking-guide.js","./icon-192.png","./icon-512.png"];
...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      const injected=html.includes("ranking-guide.js")?html:html.replace("</body>",'<script src="./ranking-guide.js?v=1"></script></body>');
