const CACHE="stackup-academy-v57";
...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=57");
      ...
      html=html.replace(/cover-layout\.js\?v=\d+/g,"cover-layout.js?v=4");
      ...
      if(!html.includes("cover-layout.js"))html=html.replace("</body>",'<script src="./cover-layout.js?v=4"></script></body>');
