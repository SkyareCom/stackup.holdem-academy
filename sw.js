const CACHE="stackup-academy-v35";
...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=35");
      html=html.replace(/terminology-extra-terms\.js\?v=\d+/g,"terminology-extra-terms.js?v=2");
      html=html.replace(/highlight-card-style\.js\?v=\d+/g,"highlight-card-style.js?v=6");
      html=html.replace(/misdeal-exposed-card-details\.js\?v=\d+/g,"misdeal-exposed-card-details.js?v=3");
      ...
      if(!html.includes("misdeal-exposed-card-details.js"))html=html.replace("</body>",'<script src="./misdeal-exposed-card-details.js?v=3"></script></body>');
      ...
      if(!html.includes("highlight-card-style.js"))html=html.replace("</body>",'<script src="./highlight-card-style.js?v=6"></script></body>');
