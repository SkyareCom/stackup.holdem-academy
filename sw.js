const CACHE="stackup-academy-v29";
const ASSETS=["./","./index.html","./manifest.webmanifest","./engine.js","./positions-table.js","./fundamentals-details.js","./misdeal-staff-details.js","./terminology-profiles-details.js","./strategic-concepts-details.js","./terminology-extra-terms.js","./cash-tournament-details.js","./highlight-card-style.js","./etiquette-details.js","./other-rules-details.js","./fundamentals-interactive-bank.js","./fundamentals-interactive.js","./icon-192.png","./icon-512.png"];
...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=29");
      ...
      html=html.replace(/fundamentals-interactive\.js\?v=\d+/g,"fundamentals-interactive.js?v=2");
      ...
      if(!html.includes("fundamentals-interactive.js"))html=html.replace("</body>",'<script src="./fundamentals-interactive.js?v=2"></script></body>');
