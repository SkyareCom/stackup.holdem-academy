...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=58");
      ...
      html=html.replace(/cover-layout\.js\?v=\d+/g,"cover-layout.js?v=5");
      html=html.replace("</head>",'<style id="stackup-header-logo-size">.brandin .logo[data-stackup-logo="1"]{width:80px!important;height:80px!important;flex:0 0 80px!important}</style></head>');
      ...
      if(!html.includes("cover-layout.js"))html=html.replace("</body>",'<script src="./cover-layout.js?v=5"></script></body>');
