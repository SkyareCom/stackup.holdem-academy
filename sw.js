...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=53");
      ...
      html=html.replace(/highlight-card-style\.js\?v=\d+/g,"highlight-card-style.js?v=24");
      ...
      html=html.replace(/practice-math-odds\.js\?v=\d+/g,"practice-math-odds.js?v=1");
      ...
      if(!html.includes("highlight-card-style.js"))html=html.replace("</body>",'<script src="./highlight-card-style.js?v=24"></script></body>');
      ...
      if(!html.includes("practice-math-odds.js"))html=html.replace("</body>",'<script src="./practice-math-odds.js?v=1"></script></body>');
