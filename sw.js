const CACHE="stackup-academy-v34";
const ASSETS=["./","./index.html","./manifest.webmanifest","./engine.js","./positions-table.js","./fundamentals-details.js","./misdeal-staff-details.js","./misdeal-exposed-card-details.js","./terminology-profiles-details.js","./strategic-concepts-details.js","./terminology-extra-terms.js","./cash-tournament-details.js","./highlight-card-style.js","./etiquette-details.js","./other-rules-details.js","./fundamentals-interactive-bank.js","./fundamentals-visual-layer.js","./fundamentals-interactive.js","./fundamentals-progress-panel.js","./icon-192.png","./icon-512.png"];
...
self.addEventListener("fetch",event=>{
  ...
  if(event.request.mode==="navigate"){
    event.respondWith(fetch(event.request).then(async resp=>{
      ...
      html=html.replace(/sw\.js\?v=\d+/g,"sw.js?v=34");
      html=html.replace(/terminology-extra-terms\.js\?v=\d+/g,"terminology-extra-terms.js?v=2");
      html=html.replace(/highlight-card-style\.js\?v=\d+/g,"highlight-card-style.js?v=5");
      html=html.replace(/misdeal-exposed-card-details\.js\?v=\d+/g,"misdeal-exposed-card-details.js?v=2");
      html=html.replace(/fundamentals-interactive-bank\.js\?v=\d+/g,"fundamentals-interactive-bank.js?v=1");
      html=html.replace(/fundamentals-visual-layer\.js\?v=\d+/g,"fundamentals-visual-layer.js?v=1");
      ...
      if(!html.includes("misdeal-exposed-card-details.js"))html=html.replace("</body>",'<script src="./misdeal-exposed-card-details.js?v=2"></script></body>');
      ...
      if(!html.includes("highlight-card-style.js"))html=html.replace("</body>",'<script src="./highlight-card-style.js?v=5"></script></body>');
      ...
      if(!html.includes("fundamentals-visual-layer.js"))html=html.replace("</body>",'<script src="./fundamentals-visual-layer.js?v=1"></script></body>');
