(() => {
  ...
  function render(){
    ...
    const completed=p.level==='ACADEMY';
    const nextJourney=completed?'<div class="me-level" style="margin-top:12px"><strong>JORNADA ACADEMY CONCLUÍDA</strong><br><span style="display:block;margin-top:7px;color:#d8c6ad;font-size:11px">VOCÊ CONSTRUIU OS FUNDAMENTOS PARA ENTENDER O JOGO E TOMAR DECISÕES MELHORES.</span><br><strong>PRONTO PARA O PRÓXIMO NÍVEL?</strong><br><span style="display:block;margin-top:7px;color:#d8c6ad;font-size:11px">CONTINUE SUA EVOLUÇÃO COM O PRÓXIMO APP DA SÉRIE STACKUP HOLD\'EM, DESENVOLVIDO PARA JOGADORES DE NÍVEL INTERMEDIÁRIO.</span><div style="margin-top:10px;color:#d4aa58">CONHECER O PRÓXIMO APP →</div></div>':'';
    return '<section class="my-evolution" data-my-evolution><h3>MINHA EVOLUÇÃO</h3><div class="me-sub">EU HERÓI × EU VILÃO</div><div class="me-grid"><div class="me-stat"><b>'+p.xp+'</b><span>XP TOTAL</span></div><div class="me-stat"><b>'+p.mastery+'%</b><span>DOMÍNIO</span></div><div class="me-stat"><b>'+p.correct+'/'+p.attempts+'</b><span>ACERTOS</span></div></div><div class="me-level"><strong>'+p.level+'</strong>'+(p.nextLevel?' · FALTAM '+next+' XP PARA '+p.nextLevel:' · NÍVEL MÁXIMO')+'</div><div class="me-compare"><div class="me-period"><b>'+(hasBaseline?p.previous.mastery+'%':'—')+'</b><span>EU VILÃO · PERÍODO ANTERIOR</span></div><div class="me-arrow">'+trend+'</div><div class="me-period"><b>'+p.recent.mastery+'%</b><span>EU HERÓI · ÚLTIMOS 7 DIAS</span></div></div>'+(areas?'<div class="me-areas">'+areas+'</div>':'<div class="me-empty">COMPLETE EXERCÍCIOS PARA CONSTRUIR SEU HISTÓRICO DE EVOLUÇÃO.</div>') +nextJourney+'</section>';
  }
